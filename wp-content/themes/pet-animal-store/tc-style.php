<?php 
	...
	if($pet_animal_store_top_spacing != false || $pet_animal_store_bottom_spacing != false || $pet_animal_store_left_spacing != false || $pet_animal_store_right_spacing != false){
		$pet_animal_store_custom_css .='#slider .carousel-caption{';
			$pet_animal_store_custom_css .='top: '.esc_html($pet_animal_store_top_spacing).'%; bottom: '.esc_html($pet_animal_store_bottom_spacing).'%; left: '.esc_html($pet_animal_store_left_spacing).'%; right: '.esc_html($pet_animal_store_right_spacing).'%;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_top_buttom_padding != false || $pet_animal_store_left_right_padding != false ){
		$pet_animal_store_custom_css .='.service-btn a, #slider a.read-more, #our-products .woocommerce a.button, .woocommerce ul.products li.product .button, #comments input[type="submit"].submit{';
			$pet_animal_store_custom_css .='padding-top: '.esc_html($pet_animal_store_top_buttom_padding).'px; padding-bottom: '.esc_html($pet_animal_store_top_buttom_padding).'px; padding-left: '.esc_html($pet_animal_store_left_right_padding).'px; padding-right: '.esc_html($pet_animal_store_left_right_padding).'px;';
		$pet_animal_store_custom_css .='}';
	}

	$pet_animal_store_button_border_radius = get_theme_mod('pet_animal_store_button_border_radius');
	$pet_animal_store_custom_css .='.service-btn a, #slider a.read-more, #our-products .woocommerce a.button, .woocommerce ul.products li.product .button, #comments input[type="submit"].submit{';
		$pet_animal_store_custom_css .='border-radius: '.esc_html($pet_animal_store_button_border_radius).'px;';
	$pet_animal_store_custom_css .='}';
	...
	if($pet_animal_store_woocommerce_button_padding_top != false){
		$pet_animal_store_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce button.button.alt, a.button.wc-forward, .woocommerce .cart .button, .woocommerce .cart input.button, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled], .woocommerce ul.products li.product .button{';
			$pet_animal_store_custom_css .='padding-top: '.esc_html($pet_animal_store_woocommerce_button_padding_top).'px; padding-bottom: '.esc_html($pet_animal_store_woocommerce_button_padding_top).'px;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_woocommerce_button_padding_right != false){
		$pet_animal_store_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce button.button.alt, a.button.wc-forward, .woocommerce .cart .button, .woocommerce .cart input.button, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled], .woocommerce ul.products li.product .button{';
			$pet_animal_store_custom_css .='padding-left: '.esc_html($pet_animal_store_woocommerce_button_padding_right).'px; padding-right: '.esc_html($pet_animal_store_woocommerce_button_padding_right).'px;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_woocommerce_button_border_radius != false){
		$pet_animal_store_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce button.button.alt, a.button.wc-forward, .woocommerce .cart .button, .woocommerce .cart input.button, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled], .woocommerce ul.products li.product .button{';
			$pet_animal_store_custom_css .='border-radius: '.esc_html($pet_animal_store_woocommerce_button_border_radius).'px;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_woocommerce_product_padding_top != false){
		$pet_animal_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$pet_animal_store_custom_css .='padding-top: '.esc_html($pet_animal_store_woocommerce_product_padding_top).'px !important; padding-bottom: '.esc_html($pet_animal_store_woocommerce_product_padding_top).'px !important;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_woocommerce_product_padding_right != false){
		$pet_animal_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$pet_animal_store_custom_css .='padding-left: '.esc_html($pet_animal_store_woocommerce_product_padding_right).'px !important; padding-right: '.esc_html($pet_animal_store_woocommerce_product_padding_right).'px !important;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_woocommerce_product_border_radius != false){
		$pet_animal_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$pet_animal_store_custom_css .='border-radius: '.esc_html($pet_animal_store_woocommerce_product_border_radius).'px;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_woocommerce_product_box_shadow != false){
		$pet_animal_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$pet_animal_store_custom_css .='box-shadow: '.esc_html($pet_animal_store_woocommerce_product_box_shadow).'px '.esc_html($pet_animal_store_woocommerce_product_box_shadow).'px '.esc_html($pet_animal_store_woocommerce_product_box_shadow).'px #aaa;';
		$pet_animal_store_custom_css .='}';
	}
	...
	if(get_theme_mod('pet_animal_store_slider_arrows') == false){
		...
		$pet_animal_store_custom_css .=' .site_header{';
			$pet_animal_store_custom_css .=' background: '.esc_html($pet_animal_store_theme_color_first).';';
		$pet_animal_store_custom_css .='}';
		$pet_animal_store_custom_css .=' .page-template-custom-frontpage .request-btn a.blogbutton-small{';
			$pet_animal_store_custom_css .=' background:'.esc_html($pet_animal_store_theme_color_second).'; color: '.esc_html($pet_animal_store_theme_color_first).';';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_preloader_color != false){
		$pet_animal_store_custom_css .='.preloader-squares .square, .preloader-chasing-squares .square{';
			$pet_animal_store_custom_css .='background-color: '.esc_html($pet_animal_store_preloader_color).';';
		$pet_animal_store_custom_css .='}';
	}
	if($pet_animal_store_preloader_bg_color != false){
		$pet_animal_store_custom_css .='.preloader{';
			$pet_animal_store_custom_css .='background-color: '.esc_html($pet_animal_store_preloader_bg_color).';';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_copyright_fontsize != false){
		$pet_animal_store_custom_css .='#footer p{';
			$pet_animal_store_custom_css .='font-size: '.esc_html($pet_animal_store_copyright_fontsize).'px; ';
		$pet_animal_store_custom_css .='}';
	}
	...
	if($pet_animal_store_copyright_top_bottom_padding != false){
		$pet_animal_store_custom_css .='#footer {';
			$pet_animal_store_custom_css .='padding-top:'.esc_html($pet_animal_store_copyright_top_bottom_padding).'px; padding-bottom: '.esc_html($pet_animal_store_copyright_top_bottom_padding).'px; ';
		$pet_animal_store_custom_css .='}';
	}
	...
	$pet_animal_store_custom_css .=' .woocommerce span.onsale{';
		$pet_animal_store_custom_css .='padding-top: '.esc_html($pet_animal_store_woocommerce_sale_top_padding).'px; padding-bottom: '.esc_html($pet_animal_store_woocommerce_sale_top_padding).'px; padding-left: '.esc_html($pet_animal_store_woocommerce_sale_left_padding).'px; padding-right: '.esc_html($pet_animal_store_woocommerce_sale_left_padding).'px;';
	$pet_animal_store_custom_css .='}';

	$pet_animal_store_woocommerce_sale_border_radius = get_theme_mod('pet_animal_store_woocommerce_sale_border_radius', 50);
	$pet_animal_store_custom_css .='.woocommerce span.onsale{';
		$pet_animal_store_custom_css .='border-radius: '.esc_html($pet_animal_store_woocommerce_sale_border_radius).'px;';
	$pet_animal_store_custom_css .='}';
	...
	$pet_animal_store_custom_css .='.footertown{';
		$pet_animal_store_custom_css .='background-color: '.esc_html($pet_animal_store_footer_background_color).';';
	$pet_animal_store_custom_css .='}';
	...
	if($pet_animal_store_footer_background_img != false){
		$pet_animal_store_custom_css .='.footertown{';
			$pet_animal_store_custom_css .='background: url('.esc_html($pet_animal_store_footer_background_img).') no-repeat; background-size: cover; background-attachment: fixed;';
		$pet_animal_store_custom_css .='}';
	}
	...
	$pet_animal_store_custom_css .='#comments textarea{';
		$pet_animal_store_custom_css .=' width:'.esc_html($pet_animal_store_comment_width).'%;';
	$pet_animal_store_custom_css .='}';
