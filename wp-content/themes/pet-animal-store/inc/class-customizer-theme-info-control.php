...
if ( ! class_exists( 'Pet_Animal_Store_Theme_Info' ) ) :

	/**
	 * Pet_Animal_Store_Theme_Info class.
	 */
	class Pet_Animal_Store_Theme_Info extends WP_Customize_Control {
		...
		/**
		 * Pet_Animal_Store_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Pet_Animal_Store_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'pet-animal-store-style', get_template_directory_uri() . '/inc/css/animal-style.css', '1.0.0' );
		}
