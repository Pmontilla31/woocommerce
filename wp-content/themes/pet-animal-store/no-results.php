...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<?php else : ?>
		...
		<div class="read-moresec">
			<a href="<?php echo esc_url( home_url() ); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Back to Home Page', 'pet-animal-store' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page', 'pet-animal-store' );?></span></a>
		</div>
<?php endif; ?>