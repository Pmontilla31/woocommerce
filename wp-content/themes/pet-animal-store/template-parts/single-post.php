...
<article>
	...
	<?php if( get_theme_mod( 'pet_animal_store_date_hide',true) != '' || get_theme_mod( 'pet_animal_store_comment_hide',true) != '' || get_theme_mod( 'pet_animal_store_author_hide',true) != '') { ?>
		<div class="metabox">
			...
			<?php if( get_theme_mod( 'pet_animal_store_author_hide',true) != '') { ?>
				<span class="entry-author"><i class="fa fa-user" aria-hidden="true"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php esc_html(the_author()); ?><span class="screen-reader-text"><?php esc_html(the_author()); ?></span></a></span>
			<?php }?>
	...
	if ( is_singular( 'attachment' ) ) {
		...
		if( get_theme_mod( 'pet_animal_store_nav_links',true) != '') {
			...
			the_post_navigation( array(
				'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html(get_theme_mod('pet_animal_store_next_text',__( 'Next Post', 'pet-animal-store' ))) . '<i class="fas fa-chevron-right"></i></span> ' .
					'<span class="screen-reader-text">' . __( 'Next Post', 'pet-animal-store' ) . '</span> ' .
					'',
				'prev_text' => '<span class="meta-nav" aria-hidden="true"><i class="fas fa-chevron-left"></i>' . esc_html(get_theme_mod('pet_animal_store_prev_text',__( 'Previous Post', 'pet-animal-store' ))) . '</span> ' .
