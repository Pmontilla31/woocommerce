    ...
    <div class="container">
        ...
        <?php }else if($pet_animal_store_left_right == 'Three Columns'){ ?>
            <div class="row">
                ...
                <div id="blog_hospital" class="col-lg-6 col-md-6">
                    <?php
                        the_archive_title( '<h1 class="entry-title">', '</h1>' );
                        the_archive_description( '<div class="taxonomy-description">', '</div>' );
                    ?>
        ...
        <?php }else if($pet_animal_store_left_right == 'Four Columns'){ ?>
            <div class="row">
                <div id="sidebar" class="col-lg-3 col-md-3"><?php dynamic_sidebar( 'sidebar-1' ); ?></div>
                <div id="blog_hospital" class="col-lg-3 col-md-3">
                    <?php
                        the_archive_title( '<h1 class="entry-title">', '</h1>' );
                        the_archive_description( '<div class="taxonomy-description">', '</div>' );
                    ?>
        ...
        <?php }else if($pet_animal_store_left_right == 'Grid Layout'){ ?>  
            <div class="row">              
                <div id="blog_hospital" class="col-lg-9 col-md-9">
                    <?php
                        the_archive_title( '<h1 class="entry-title">', '</h1>' );
                        the_archive_description( '<div class="taxonomy-description">', '</div>' );
                    ?>
