			...
			<div class="container">
		        <?php if( get_theme_mod('pet_animal_store_sec1_title') != ''){ ?>     
		            ...
		            <div class="border-image">
		    			<img  role="img" src="<?php echo esc_url(get_theme_mod('pet_animal_store_border_image',get_template_directory_uri().'/images/line.png')); ?>" alt="<?php esc_attr_e( 'Border Image','pet-animal-store' );?>">
		    		</div>
		        <?php }?>
