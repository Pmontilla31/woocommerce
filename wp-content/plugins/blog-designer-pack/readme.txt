...
Tags: blog, post ticker, news, news page, blog template, post slider, post carousel, custom blog template, blog layout design, custom blog layout, modify blog design, blog,  posts in page, blog in page, grid blog template, list blog template, masonry blog template, slider blog template, carousel blog template, post ticker, blog widgets, post filter
...
Display Posts on your website with 6 layouts (2 designs for each layout) plus 1 Ticker and 2 Widgets

== Description ==

Blog Designer Pack display WordPress posts with multiple designs. Blog Designer Pack can also use to create a news page for your website.

= ✅ Blog Designer Pack having 7 layouts/shortcodes: =

* 6 shortcodes with 2 designs for each layout. 
...
= ✅ This Blog Designer Pack contains 7 shortcodes =

* <code>[bdp_post]</code> : Display blog post in grid view.
* <code>[bdp_post_list]</code> : Display blog post in list view.
* <code>[bdp_masonry]</code> : Display blog post in masonry layouts.
* <code>[bdp_post_slider]</code> : Display recent blog post in slider view.
* <code>[bdp_post_carousel]</code> : Display recent blog post in carousel view.
* <code>[bdp_post_gridbox]</code> : Display blog post in grid box layout.
* <code>[bdp_ticker]</code> : Display blog post in ticker.

= Common Shortcode Parameters for all =

* **Limit:**
limit="10" ( ie Display 5 posts on your website and then pagination. To show all posts use limit="-1" )

* **Display by Category**
category="category_ID" ( ie Display posts by their category ID )
...
* **Post Grid :**
[bdp_post grid="2"] (Set post grid ie 1 or 2 or 3 or 4 or 5 )

* **Post Pagination :**
[bdp_post pagination="true"] (Show post pagination or not. Values are true or false )
...
* **Post Pagination :**
[bdp_post_list pagination="true"] (Show post pagination or not. Values are true or false )
...
* **Post Grid :**
[bdp_masonry grid="2"] (Set post grid ie 1 or 2 or 3 or 4 or 5 )

* **Post Pagination :**
[bdp_masonry pagination="true"] (Show post pagination or not. Values are true or false )
